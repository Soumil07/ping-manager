...
import { ResponseType, ResponseValue, ScheduleEntity } from '@lib/database/entities/TaskEntity';
import { Cron, Time, TimerManager } from '@sapphire/time-utilities';
...
export class TaskManager {
	...
	private _checkInterval(): void {
		...
		else if (!this.#interval) this.#interval = TimerManager.setInterval(this.execute.bind(this), this.client.options.schedule?.interval ?? Time.Minute);
	}
